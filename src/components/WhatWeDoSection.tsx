...
const WhatWeDoSection: React.FC = () => {
  ...
  return (
    <section className="w-screen py-16 lg:py-24 bg-background">
      <div className="px-6 lg:px-24">
        ...
        >
          <h2 className="font-futura-light text-5xl md:text-6xl lg:text-7xl text-primary tracking-[0.2em] leading-none mb-8">
            O QUE
            <br />
            FAZEMOS
          </h2>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="flex-1">
                  <h3 className="font-futura-medium text-xl md:text-2xl text-foreground mb-2 tracking-wide">
                    {service.title}:
                  </h3>
                  <p className="font-futura text-lg md:text-xl text-foreground/70 leading-relaxed font-light">
                    {service.description}
                  </p>
                </div>
              </motion.div>
