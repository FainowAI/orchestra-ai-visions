        ...
        >
          ...
          <div>
            ...
            >
              <Button 
                size="lg"
                className="font-futura tracking-widest bg-primary text-white hover:bg-primary/90 transition-all duration-500 px-12 py-6 text-lg uppercase"
              >
                Nossos Projetos
              ...
              <div className="block">
                <Button 
                  variant="ghost"
                  size="lg"
                  className="font-futura tracking-widest bg-transparent border-none text-foreground/60 hover:text-primary hover:bg-transparent transition-all duration-500 px-0 py-6 text-lg uppercase underline decoration-1 underline-offset-8"
                >
                  Processo Criativo
                </Button>
              </div>
